...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  // Density-based vanishing zone:
  // fwidth tells us how many grid cells span one pixel.
  // When this grows large (lines converge / vanishing point), fade them out smoothly.
  float density = max(max(wx, wy), max(wx2, wy2));
  float densityFade = 1.0 - smoothstep(0.2, 0.55, density);
